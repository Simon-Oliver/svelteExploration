...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	var div, ul, li0, t1, li1, t3, li2, t5, li3, t7, li4, dispose;
    	...
    	return {
    		c: function create() {
    			...
    			attr(li0, "class", "header-link svelte-158ulsv");
    			add_location(li0, file, 37, 4, 699);
    			attr(li1, "class", "header-link svelte-158ulsv");
    			add_location(li1, file, 38, 4, 737);
    			attr(li2, "class", "header-link svelte-158ulsv");
    			add_location(li2, file, 39, 4, 776);
    			attr(li3, "class", "header-link svelte-158ulsv");
    			add_location(li3, file, 40, 4, 817);
    			attr(li4, "class", "header-link svelte-158ulsv");
    			add_location(li4, file, 41, 4, 859);
    			attr(ul, "class", "link-container svelte-158ulsv");
    			add_location(ul, file, 36, 2, 643);
    			attr(div, "class", "nav header-container svelte-158ulsv");
    ...
    */
    ...
    /* src/components/OrderInput.svelte generated by Svelte v3.9.1 */

    const file$a = "src/components/OrderInput.svelte";
    ...
    function create_fragment$a(ctx) {
    	...
    	return {
    		c: function create() {
    			div = element("div");
    			h3 = element("h3");
    			h3.textContent = "Order Input";
    			add_location(h3, file$a, 9, 2, 136);
    			attr(div, "class", "input-container svelte-1mt7wro");
    			add_location(div, file$a, 8, 0, 104);
    		},
    ...
    class OrderInput extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    /* src/components/OrderDisplay.svelte generated by Svelte v3.9.1 */

    const file$b = "src/components/OrderDisplay.svelte";
    ...
    function create_fragment$b(ctx) {
    	...
    	return {
    		c: function create() {
    			div = element("div");
    			h3 = element("h3");
    			h3.textContent = "Order Display";
    			add_location(h3, file$b, 9, 2, 131);
    			attr(div, "class", "order-container svelte-ucoapk");
    			add_location(div, file$b, 8, 0, 99);
    		},
    ...
    class OrderDisplay extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    /* src/components/pages/Order.svelte generated by Svelte v3.9.1 */

    const file$c = "src/components/pages/Order.svelte";

    function create_fragment$c(ctx) {
    	var div, t, current;

    	var orderdisplay = new OrderDisplay({ $$inline: true });

    	var orderinput = new OrderInput({ $$inline: true });

    	return {
    		c: function create() {
    			div = element("div");
    			orderdisplay.$$.fragment.c();
    			t = space();
    			orderinput.$$.fragment.c();
    			attr(div, "class", "order-container svelte-aew2z9");
    			add_location(div, file$c, 13, 0, 238);
    		},
    		...
    		m: function mount(target, anchor) {
    			insert(target, div, anchor);
    			mount_component(orderdisplay, div, null);
    			append(div, t);
    			mount_component(orderinput, div, null);
    			current = true;
    		},
    		...
    		i: function intro(local) {
    			if (current) return;
    			transition_in(orderdisplay.$$.fragment, local);

    			transition_in(orderinput.$$.fragment, local);

    			current = true;
    		},

    		o: function outro(local) {
    			transition_out(orderdisplay.$$.fragment, local);
    			transition_out(orderinput.$$.fragment, local);
    			current = false;
    		},
    		...
    		d: function destroy(detaching) {
    			...
    			destroy_component(orderdisplay);

    			destroy_component(orderinput);
    		}
    	};
    }
    ...
    function create_fragment$d(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(main, file$d, 37, 2, 748);
    			attr(div, "class", "app-container svelte-1lm8tcl");
    			add_location(div, file$d, 35, 0, 690);
    		},
    ...
    class App extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$8, create_fragment$d, safe_not_equal, ["handleSelect"]);
    	}
